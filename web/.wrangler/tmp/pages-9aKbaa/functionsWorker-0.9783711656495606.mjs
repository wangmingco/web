...
__name(convertToLineStack2, "convertToLineStack");
function startDate3() {
  const now = new Date((/* @__PURE__ */ new Date()).getTime() + 8 * 60 * 60 * 1e3);
...
// ../.wrangler/tmp/pages-9aKbaa/functionsRoutes-0.2460156016147983.mjs
var routes = [
  {
...
// C:/Users/wang/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/wang/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-Tvoxvo/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Tvoxvo/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9783711656495606.mjs.map
